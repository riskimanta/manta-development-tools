...
| `src/app/projects/work-progress/**`, `src/services/work-progress.ts`, `src/lib/git-work-progress-capture.ts`, `src/components/projects/*work-progress*` | [work-progress-snapshot.md](./work-progress-snapshot.md) |
