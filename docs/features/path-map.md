...
| `src/app/projects/work-progress/**`, `src/app/(app)/projects/[id]/work-progress/**`, `src/app/api/work-progress/**`, `src/services/work-progress.ts`, `src/services/work-progress-session-summaries.ts`, `src/lib/validations/work-progress-session-summary.ts`, `src/lib/git-work-progress-capture.ts`, `src/lib/project-local-path-match.ts`, `src/lib/work-progress-dedupe.ts`, `src/lib/work-progress-session.ts`, `src/lib/work-progress-session-filter.ts`, `src/lib/work-progress-dashboard-summary.ts`, `src/lib/work-progress-session-ui.ts`, `src/lib/work-progress-session-summary-preview.ts`, `src/lib/work-progress-ai-summary-prompt.ts`, `src/lib/mandev-agent-auth.ts`, `bin/mandev.mjs`, `src/components/projects/*work-progress*` | [work-progress-snapshot.md](./work-progress-snapshot.md) |
| `docs/features/work-progress-phase-5-closure.md` | [work-progress-phase-5-closure.md](./work-progress-phase-5-closure.md) |
