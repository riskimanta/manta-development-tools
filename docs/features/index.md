...
| Work progress snapshot (Phase 5A + 5B + 5C + 5D + 5E + 5F + 5G) | Manual Git snapshot capture, `mandev track` CLI, watch mode, derived session view, session detail page, copyable AI summary prompt, and manual saved AI summaries | [work-progress-snapshot.md](./work-progress-snapshot.md) |
